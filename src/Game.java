...
public class Game implements KeyListener {
    ...
    private Snake player; //instance of player
    private Food food; //instance of food
    ...
    public Game(){
        ...
        window.setSize(width*dimension + 2,height*dimension + 4); //600,600
